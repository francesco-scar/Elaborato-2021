...
%      emphstyle=\bfseries\color{blue}%  style for emph={} 
    ...
    \lstdefinestyle{Arduino}{%
        language = Octave,
        keywords=[1]{digitalRead, digitalWrite, micros, millis, delay, delayMicroseconds, pinMode, pow, sqrt},
  ...
  for (int8_t y = 0; y < 16; y++) {
    for (int8_t x = 0; x < 16; x++) {
      gradient_modules[y][x] = sqrt(pow(matrix[y + 2][x + 1] - matrix[y][x + 1], 2) + pow(matrix[y + 1][x + 2] - matrix[y + 1][x], 2)) + 0.5;
        ...
        \begin{figure}[h]
        \centering
            \includegraphics[width=\textwidth-30pt]{Draws/matplotlib_draws/4d_descent_volume_block.png}
        ...
        \begin{changemargin}{-2cm}{-2cm}
        \begin{lstlisting}[label={list:edge_detection_code}, style=Arduino, caption=Ricerca minimi - discesa del gradiente, basicstyle=\scriptsize]
